  ...
  return (
    ...
    >
      ...
      <div className=" h-full overflow-scroll lg:flex" ref={containerRef}>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:2/3 lg:pr-0 xl:1/2">
          {/* BIOGRAPHY CONTAINER */}
        ...
        <div className="flex flex-col gap-12 justify-center">
          ...
          <div className=" flex gap-4 flex-wrap">
            <div className="rounded p-2 text-sm text-white bg-black cursor-pointer hover:bg-white hover:text-black">
              JavaScript
            </div>
            <div className="rounded p-2 text-sm text-white bg-black cursor-pointer hover:bg-white hover:text-black">
              React.js
            ...
            <div className="flex justify-between h-48">
              ...
              <div className="w-1/3 ">
                ...
                <div className="p-3 text-sm italic">
                  ...
                  frameworks, Figma and Wordpress.
                </div>
                {/* JOB DATE */}
